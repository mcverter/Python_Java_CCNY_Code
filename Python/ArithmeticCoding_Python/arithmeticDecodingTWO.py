...
def main():
    ...
    if (letter_total != total_length):
        ...
        print ("Exiting ...")
        return (-1)
    encoded_value=Decimal(raw_input("Please enter your the decimal value of your string:  "))
    
    total_count=total_length
    fullstring = ""
    for i in range (total_length):
        symbol=calculate_symbol(encoded_value)
        if (i%10 == 9):
            recalculate_certainties()
        fullstring = fullstring + symbol    

    print "Decoded Value is %s" % fullstring
